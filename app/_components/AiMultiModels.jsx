...
function AiMultiModels() {
  const [AiMultiModels, setAiModelList] = useState(AiModelList)
  ...
  >
    <div className="flex w-full h-[70px] gap-2 items-center justify-between border-b p-4">
      <div className="flex item-centre gap-4 w-full">
        <Image
          src={model.icon}
          alt={model.model}
          width={24}
    ...
    {model.premium&&model.enable&& <div  className='flex items-centre justify-center h-full'>
